...
//is coming from ---->import static org.hamcrest.Matchers.*;
           ...
           then assert that status code us 200
           and asser that region name Europe
             */
           @Test
        public void test3(){
           given()
            ...
            .when()
             ...
             .then()
                   ...
                   .time(lessThan(10L), TimeUnit.SECONDS)//verify that response time is less than 10 seconds
                   .log().body(true);
           //.log().all(true);
